...
+ (ADSuyiKitTimer *)timerWithTimeInterval:(NSTimeInterval)interval target:(id)atarget selector:(SEL)aSelector repeats:(BOOL)yesOrNo runLoopMode:(NSRunLoopMode)runLoopMode;
